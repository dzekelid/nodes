...
- name: AWS ElastiCache API - List Allowed Node Type Modifications
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/nodes/master/_listings/aws-elasticache/actionlistallowednodetypemodifications-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/nodes/master/_listings/aws-elasticache/actionlistallowednodetypemodifications-get-openapi.md
- name: AWS ElastiCache API - List Available Node Types
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/nodes/master/_listings/aws-elasticache/actionlistavailablenodetypes-get-openapi.md
...
- name: AWS ElastiCache API - Reboot Cache Cluster
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/nodes/master/_listings/aws-elasticache/actionrebootcachecluster-get-openapi.md
- name: AWS ElastiCache API - List Allowed Node Type Modifications
  x-api-slug: actionlistallowednodetypemodifications-get
  description: |-
    Lists all available node types that you
