...
apis:
- name: AWS Redshift API - Describe Reserved Nodes
  x-api-slug: actiondescribereservednodes-get
...
- name: AWS Redshift API - Describe Reserved Node Offerings
  x-api-slug: actiondescribereservednodeofferings-get
  description: |-
...
- name: AWS Redshift API - Describe Reserved Nodes
  ...
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/nodes/master/_listings/aws-redshift/actiondescribereservednodes-get-openapi.md
- name: AWS Redshift API - Purchase Reserved Node Offering
  x-api-slug: actionpurchasereservednodeoffering-get
