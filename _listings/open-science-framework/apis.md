...
- name: Open Science Framework - Root
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/nodes/master/_listings/open-science-framework/get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/nodes/master/_listings/open-science-framework/get-openapi.md
- name: Open Science Framework - Delete a node
  x-api-slug: nodesnode-id-delete
  description: |-
    Permanently deletes a node. This action cannot be undone.
...
- name: Open Science Framework - Actions
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/nodes/master/_listings/open-science-framework/actions-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/nodes/master/_listings/open-science-framework/actions-get-openapi.md
- name: Open Science Framework - List all identifiers
  x-api-slug: nodesnode-ididentifiers-get
  description: |-
    List all identifiers associated with a given node.
